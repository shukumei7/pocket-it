...
public class LocalDatabase : IDisposable
{
    ...
    private readonly System.Security.Cryptography.DataProtectionScope _dpScope;

    public LocalDatabase(string dbPath, bool useLocalMachineProtection = false)
    {
        _dpScope = useLocalMachineProtection
