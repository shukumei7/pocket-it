...
echo.
echo === Build complete! ===
echo Installer: %~dp0output\PocketIT-0.2.0-setup.exe
echo.
echo Silent install:  PocketIT-0.2.0-setup.exe /SILENT
echo Very silent:     PocketIT-0.2.0-setup.exe /VERYSILENT /SUPPRESSMSGBOXES
echo Custom config:   PocketIT-0.2.0-setup.exe /SILENT /DIR="C:\PocketIT"
